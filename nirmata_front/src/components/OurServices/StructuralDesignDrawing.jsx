...
import s from "./css/structuraldesing.module.css";
  ...
  return (
    <div>
      <div class={s.container}>
        ...
        <ul>
          <li>
            <span className={s.highlight}>Foundational Layouts:</span> These
            drawings showcase the layout and depth of the building’s foundation,
            ensuring it can bear the load of the structure.
          </li>
          <li>
            <span className={s.highlight}>Load Calculations:</span> A
          ...
          <li>
            <span className={s.highlight}>Beam and Column Details:</span> These
            are essential elements that transfer load from the slabs to the
            foundation. The structural drawing will show the size, material, and
            placement of beams and columns.
          </li>
          <li>
            <span className={s.highlight}>Material Specifications:</span> It
            includes details about the type of concrete, steel, and other
            materials used, ensuring compliance with safety standards.
          </li>
          <li>
            <span className={s.highlight}>Reinforcement Plans:</span>{" "}
          ...
          <li>
            <span className={s.highlight}>Safety Considerations:</span> Every
            structural design drawing integrates safety measures to comply with
            local building codes and international standards, ensuring the
        ...
        <ul>
          <li>
            <span className={s.highlight}>Precision and Clarity:</span>{" "}
          ...
          <li>
            <span className={s.highlight}>Safety and Compliance:</span> By
          ...
          <li>
            <span className={s.highlight}>Cost Efficiency:</span> Accurate
